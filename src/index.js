// Public key
// f45894484c2948ecff9c2eb520a5e66d
// md5(hash)=75f0352349d9cab371243c36df41d086

function getCharacters() {
  // API call to get the data
  const char_url = `https://gateway.marvel.com/v1/public/characters?&ts=1&apikey=f45894484c2948ecff9c2eb520a5e66d&hash=75f0352349d9cab371243c36df41d086&limit=100`;
  getCharApi(char_url);
}
getCharacters();
  ...
  data.forEach((hero) => {
    charListUl.innerHTML += `
               <div class="flex-col card">
                    ...
                    <span class="comics">Comics : ${
                      hero.comics.available
                    }</span>
                    <span class="series">Series : ${
...
async function searchHeros(textSearched) {
  ...
  // API call to get the data
  await fetch(
    `https://gateway.marvel.com/v1/public/characters?nameStartsWith=${textSearched}&apikey=f45894484c2948ecff9c2eb520a5e66d&hash=75f0352349d9cab371243c36df41d086&ts=1`
  )
...
function showSearchedResults(searchedHero) {
  ...
  // if the id exist in this array then we display "Remove from favourites" icon otherwise we display "Add to favourites icon"
